...
describe('useCallStore', () => {
  describe('reactivity', () => {
    ...
    it('should update when store state is modified', () => {
      ...
      expect(result.current.value).toHaveLength(1);
      expect(result.current.value[0].payload).toBe('initial-payload');
  ...
  describe('multiple hooks synchronization', () => {
    it('should keep multiple hooks in sync with the same store', () => {
      ...
      expect(result1.current.value).toEqual(result2.current.value);
    });
...
describe('useSingletonCallStore', () => {
  ...
  describe('multiple hooks synchronization', () => {
    it('should keep multiple hooks in sync with the same store', () => {
      ...
      expect(result1.current.value).toBe(result2.current.value);
    });
